...
<body class="corp">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img/top-img-01.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/top-img-02.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/top-img-03.jpg" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/top-img-04.jpg" alt="Fourth slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/top-img-05.jpg" alt="Fifth slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/top-img-06.jpg" alt="Sixth slide">
            </div>
        </div>
    </div>
    <!-- *** CAROUSEL END ***-->
    ...
    <div class="container welcome-box">
        <div class="row">
            <div class="col-md-12 welcome-text-box">
                <p id="welcome">welcome to</p>
                <h2 id="site-title">exquisite foliage</h2>
                <br>
                <p id="intro-text">Turn over a <span>new leaf</span> and check out these <span>unbeleafable</span> offers that will have you <span>falling</span> down</p>
            </div>
        </div>
    </div>
    <!-- *** WELCOME BOX END ***-->
    ...
    <!-- *** ICON BOX ***-->
    <div class="container" id="icon-box">
        <img src="img/qualityIcon-01.png" class="quality-icons" alt="quality icon 1">
        <img src="img/qualityIcon-02.png" class="quality-icons" alt="quality icon 1">
        <img src="img/qualityIcon-03.png" class="quality-icons" alt="quality icon 1">
    </div>
    <!-- *** ICON BOX END ***-->
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12 product-header-box">
                ...
                <h2 class="product-header">HOT THIS WEEK</h2>
    ...
    while($row = mysqli_fetch_assoc($result)){
        showProduct($row['product_name'], $row['product_image'], $row['product_price']);
    }
    ?>               
        </div>
    </div>
