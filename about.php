...
<body class="corp">
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12 product-header-box">
                ...
                <h2 class="product-header">About us</h2>
    ...
    <!-- *** ABOUT BOX ***-->
    <div class="container mt-4">
        <div class="row col-container about-container">
            <div class="col-sm-4 p-3">
                <img src="img/about-leaf.jpg" id="about-leaf">
            </div>
            <div class="col-sm-8 p-3" id="about-text">
                <img src="img/about-logo.png" alt="about-logo" style="width: 60%">
                <p class="mt-4" id="about-text-tag">We try our best so that you don't <span>leaf</span> empy handed</p>
                <p class="mt-4">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl
                ...
                <div id="footer" style="background-color: #F8EEE1;">
                    <div class="footer-content" style="text-align: center">
                        <h4 class="mb-2 mt-5" id="stay-in-touch">Stay in touch</h4>
                        <hr style="background-color: #F8EEE1; width:50%;">
